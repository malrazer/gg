...
# https://github.com/malrazer/wireguard-install
...
function installQuestions() {
	...
	echo "The git repository is available at: https://github.com/malrazer/wireguard-install"
	echo ""
...
function newClient() {
	...
	echo "The name must consist of alphanumeric character. It may also include an underscore or a dash and can't exceed 15 characters."
